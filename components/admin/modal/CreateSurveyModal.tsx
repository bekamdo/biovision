      ...
      <div className="flex min-h-full items-center justify-center p-4 sm:p-6 lg:p-8">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            {/* Description */}
            <div>
              <h3 className="text-[#2C2A29] text-xl font-bold mb-4">Description</h3>
              <textarea
            ...
            {/* Sample Questions UI */}
            <div>
              <h3 className="text-[#2C2A29] text-xl font-bold mb-4">Sample Questions</h3>
              <div className="space-y-4">
                <div className="flex items-center justify-between border-b pb-2 text-[#2C2A29]/70">
                  <span>Untitled Question</span>
