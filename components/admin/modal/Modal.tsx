...
import { tags } from "@/app/data/sampledata";
      ...
      <div className="flex min-h-full items-center justify-center p-4 sm:p-6 lg:p-8">
        ...
        >
          ...
          <div className="flex justify-center">
            <button className="bg-[#2E7D32] text-[#FDFBF6] text-sm font-bold leading-normal px-[60px] py-5 rounded-full hover:bg-[#2E7D32]/90 transition-colors">
              Add Product
            </button>
          </div>
        </div>
