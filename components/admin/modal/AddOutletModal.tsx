        ...
        >
          ...
          <div className="flex flex-col items-center gap-2.5 mb-5">
            ...
            <p className="text-[#2C2A29] text-lg sm:text-xl font-normal leading-[150%] text-center">
              Add, edit, and manage Outlet here.
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <button 
              onClick={onClose}
              className="bg-[#FDFBF6] text-[#2E7D32] ring-[#2E7D32] ring-1 text-sm font-bold leading-normal px-[60px] py-5 rounded-full hover:bg-[#FDFBF6]/90 transition-colors"
            >
              Add Product
            </button>
          </div>
