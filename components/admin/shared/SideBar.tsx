...
export function Sidebar() {
  ...
  return (
    <div
      className={`${isCollapsed ? "w-[102px]" : "w-[303px]"} h-[1007px] border-r border-line-border bg-white hidden md:flex flex-col relative transition-all duration-300 ease-in-out`}
    >
      {/* Logo */}
      <div
